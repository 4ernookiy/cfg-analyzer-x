...
<nav
	class="navbar  navbar-inverse bg-inverse fixed-top">
	<a class="navbar-brand" href="http://datalex.com/">Datalex</a>

	<div class="collapse navbar-collapse" id="navbarsExampleDefault">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link"
				href="https://v4-alpha.getbootstrap.com/examples/starter-template/#">Home
					<span class="sr-only">(current)</span>
			</a></li>
			<li class="nav-item"><a class="nav-link"
				href="https://v4-alpha.getbootstrap.com/examples/starter-template/#">Link</a>
			</li>
			<li class="nav-item"><a class="nav-link disabled"
				href="https://v4-alpha.getbootstrap.com/examples/starter-template/#">Disabled</a>
			</li>
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="dropdown01">
					<a class="dropdown-item"
						href="https://v4-alpha.getbootstrap.com/examples/starter-template/#">Action</a>
					<a class="dropdown-item"
						href="https://v4-alpha.getbootstrap.com/examples/starter-template/#">Another
						action</a> <a class="dropdown-item"
						href="https://v4-alpha.getbootstrap.com/examples/starter-template/#">Something
						else here</a>
				</div></li>
		</ul>
